...
const Hero = () => {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs("div", {
        className: "max-w-x grid grid-cols-12 items-center",
        children: [
          /* @__PURE__ */ jsx("div", {
            className: "col-span-8",
            children: /* @__PURE__ */ jsx("h1", {
              children: "I'm Michael - Web Developer & Software Engineer",
            }),
          }),
          /* @__PURE__ */ jsx("div", {
      ...
      /* @__PURE__ */ jsx("div", {
        className: "section-col flex gap-4",
        children: /* @__PURE__ */ jsx("h3", {
          className: "",
          children:
            "Driven Software Engineer with 2 years of experience building, upgrading, and maintaining websites. Team Collaborator and Passionate about the product.",
        }),
      }),
    ],
  });
};
function KeyWordScroll({ showFullList, setShowFullList, slides }) {
      ...
      ? slides.map((slideArray, i) => {
          ...
          return /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: slideArray.map((text, i2) =>
                /* @__PURE__ */ jsx(
                  "h3",
                  { className: "banner-text", children: text },
                  i2
                )
              ),
            },
...
const About = () => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsx("div", {
        className: "mb-20 section-col !pt-0",
        children: /* @__PURE__ */ jsx(KeyWordScroll, {
          slides: [
      ...
      /* @__PURE__ */ jsxs("div", {
        className: "flex flex-col section-col",
        children: [
          /* @__PURE__ */ jsxs("p", {
            children: [
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsxs("div", {
              className: seeMore ? "relative block" : "hidden",
              children: [
                /* @__PURE__ */ jsxs("p", {
                  children: [
      ...
      /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", {
              className: "flex flex-col gap-2 section-col",
              children: [
                /* @__PURE__ */ jsxs("div", {
                  className: "flex flex-col gap-0 section-col !p-0",
                  children: [
                    /* @__PURE__ */ jsx("h2", {
                      className: "my-0",
                    ...
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("h3", {
                          children: "Software Engineering Immersive Resident",
                        }),
                        /* @__PURE__ */ jsx("p", {
                          className: "italic",
                          children: "Hack Reactor",
                        }),
                ...
                /* @__PURE__ */ jsxs("div", {
                  className: "flex flex-col section-col !p-0",
                  children: [
                    /* @__PURE__ */ jsx("h2", {
                      className: "mb-0",
                      children: "Education",
                    ...
                    /* @__PURE__ */ jsx("h3", {
                      children: "Bootcamp Certificate",
                    }),
                    /* @__PURE__ */ jsx("p", {
                      children: "Hack Reactor - 2021",
                    }),
                    /* @__PURE__ */ jsx("h3", { children: "Bachelor of Arts" }),
                    /* @__PURE__ */ jsx("p", {
                      children:
                        "College of Charleston - Art's Management - 2015-2019",
                    }),
                  ],
                }),
              ],
...
function Index() {
  return /* @__PURE__ */ jsxs("div", {
    children: [/* @__PURE__ */ jsx(Hero, {}), /* @__PURE__ */ jsx(About, {})],
  });
}
...
const serverManifest = {
  entry: {
    module: "/assets/entry.client-DyY_Wzg3.js",
    imports: [
      "/assets/jsx-runtime-56DGgGmo.js",
      "/assets/components-CnnW4tk2.js",
    ],
    css: [],
  },
  routes: {
    root: {
      ...
      module: "/assets/root-DnG0VfyE.js",
      imports: [
        "/assets/jsx-runtime-56DGgGmo.js",
        "/assets/components-CnnW4tk2.js",
      ],
    ...
    "routes/_index": {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: "/assets/_index-ltEen4Dj.js",
      imports: ["/assets/jsx-runtime-56DGgGmo.js"],
      css: [],
    },
  },
  url: "/assets/manifest-6ada6c93.js",
  version: "6ada6c93",
};
